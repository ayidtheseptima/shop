	...
	<?php
		...
		if (isset($_POST['nickname']) && !empty($_POST['nickname'])
		    ...
		    if (!empty($nickname_result['user_id'])) {
		    	echo "
			        <script type=\"text/javascript\">
			          alert('Имя пользователся уже занято!');
			          window.location='sign_up.php';
			        </script>
			      ";
			      die();
			...
			<div class=\"main-content\">
				<div class=\"container\">
					<h1 class=\"reg-form-head\">Регистрация</h1>
					<div class=\"wrap\">
						<form action=\"sign_up.php\" method=\"post\">
							...
							<div class=\"reg-form-item\">
								<div class=\"reg-form-item_lab\">Имя пользователся</div>
							...
							<div class=\"reg-form-item\">
								<div class=\"reg-form-item_lab\">Подтвердждение пароля</div>
								<div class=\"reg-form-item_inp\"><input type=\"password\" name=\"password2\" required=\"\" class=\"reg-form-item_input\"></div>
							</div>
							<input type=\"submit\" class=\"reg-form-submit-button\" value=\"Зарегистрироваться\">
						</form>
					</div>
				</div>
			</div>";
