      ...
      <div class=\"content\">
        <div class=\"container\">
          <div class=\"settings-header\"><h1>Update account info:</h1></div>
            ...
            <div class=\"settings-header\">Выбор цветовой темы:</div>
            <div class=\"settings-list\">
              <div class=\"theme-option\">
                <a href=\"user_settings.php?action=set_theme&theme=dark\">-Темная</a>
              </div>
              <div class=\"theme-option\">
                <a href=\"user_settings.php?action=set_theme&theme=white\">-Светлая</a>
              </div>
            </div>
            <div class=\"settings-header\">Choose language</div>
            <div class=\"settings-list\">
              <div class=\"theme-option\">
                <a href=\"../user_settings.php?action=update_info\">-Английский</a>
              </div>
              <div class=\"theme-option\">
                <a href=\"user_settings.php?action=update_info\">-Русский</a>
              </div>
              <div class=\"theme-option\">
                <a href=\"../ua/user_settings.php?action=update_info\">-Украинский</a>
              </div>
            </div>
          </div>
        ";
