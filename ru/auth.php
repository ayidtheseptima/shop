	...
	<div class=\"main_content\">
		<div class=\"authorization\">
			...
			<form method=\"post\" action=\"auth.php\">
				...
				<input class =\"auauthorization-button\" type=\"submit\" value=\"Ввойти\"><br>
				or<br>
				<a href=\"sign_up.php\"><input type=\"button\" class =\"auauthorization-button\" value=\"Зарегистрироваться\"></a>
			</form>
		</div>
	</div>";
}
