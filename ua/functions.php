...
function do_html_header_unlogged(){
	...
	<header><ul class=\"header\">
	    ...
	    <li class=\"header__part header__navigation\"><a href=\"auth.php\">Ввійти</a></li>
	  ...
	  <nav class=\"menu\">
	  	<ul class=\"menu__list\">
	  		...
	  		<li>
	  			<a href=\"index.php?action=products_by_grand_group&grand_group_id=1\" class=\"menu__link\">Переферія</a>
	  			<span class=\"menu__arrow arrow\"></span>
	  			<ul class=\"sub-menu__list\">
	  				<li>
	  					<a href=\"index.php?action=products_by_group&group_id=1\" class=\"sub-menu__link\">Клавиатури</a>
	  				</li>
	  				<li>
	  					<a href=\"index.php?action=products_by_group&group_id=2\" class=\"sub-menu__link\">Миші</a>
	  				</li>
	  				<li>
	  					<a href=\"index.php?action=products_by_group&group_id=3\" class=\"sub-menu__link\">Коврики для миші</a>
	  				</li>
	  				<li>
	  					<a href=\"index.php?action=products_by_group&group_id=4\" class=\"sub-menu__link\">Пристрої зберігання данихх</a>
	  				</li>
	  			</ul>
	  		</li>
	  		<li>
	  			<a href=\"index.php?action=products_by_grand_group&grand_group_id=2\" class=\"menu__link\">Консолі</a>
	  			<span class=\"menu__arrow arrow\"></span>
	  			<ul class=\"sub-menu__list\">
	  				<li>
	  		...
	  		<li>
	  			<a href=\"index.php?action=products_by_grand_group&grand_group_id=3\" class=\"menu__link\">Мобільні аксесуари</a>
	  			<span class=\"menu__arrow arrow\"></span>
	  			<ul class=\"sub-menu__list\">
	  				<li>
	  					<a href=\"index.php?action=products_by_group&group_id=7\" class=\"sub-menu__link\">Колонки для мобільних</a>
	  				</li>
	  				<li>
	  					<a href=\"index.php?action=products_by_group&group_id=8\" class=\"sub-menu__link\">Зовнішній акумулятор</a>
	  				</li>
	  				<li>
	  					<a href=\"index.php?action=products_by_group&group_id=9\" class=\"sub-menu__link\">Різне</a>
	  				</li>
	  			</ul>
	  		</li>
	  		<li>
	  			<a href=\"index.php?action=brand_list\" class=\"menu__link\">Список брендів</a>
	  		</li>
	  	</ul>
	  </nav>
	  </header>
...
function do_html_header_logged($user_id,$user_role){
	...
	<header>
		<ul class=\"header\">
	   	...
	   	<li class=\"header__part header__navigation\">
	    	<form method=\"post\" action=\"index.php?action=search\">
	    		<input type=\"text\" name=\"search-request\" autocomplete=\"off\" class=\"search-form_request-field\" placeholder=\"Пошук\">
	    	</form>
	   	</li>
	   	<li class=\"header__part droplist\">
	      	...
	      	<ul class=\"droplist__list\">
	      		<li><a href=\"user_settings.php?action=update_info\">Налаштування</a></li>
	      		<li><a href=\"index.php?action=orders_list\">Мої замовлення</a></li>";
	   if ($user_role>1) {
	   	echo"
	   			<li><a href=\"orders.php?action=view_orders\">Замовлення</a></li>
	   	";
	   }
	   echo"
	      		<li><a href=\"index.php?action=log_out\">Ввійти</a></li>
	      	</ul>
	    	</li>
	  ...
	  <nav class=\"menu\">
	  	<ul class=\"menu__list\">
	  		...
	  		<li>
	  			<a href=\"index.php?action=products_by_grand_group&grand_group_id=1\" class=\"menu__link\">Периферія</a>
	  			<span class=\"menu__arrow arrow\"></span>
	  			<ul class=\"sub-menu__list\">
	  				<li>
	  					<a href=\"index.php?action=products_by_group&group_id=1\" class=\"sub-menu__link\">Клавиатури</a>
	  				...
	  				<li>
	  					<a href=\"index.php?action=products_by_group&group_id=3\" class=\"sub-menu__link\">Килимки для миші</a>
	  				</li>
	  				<li>
	  					<a href=\"index.php?action=products_by_group&group_id=4\" class=\"sub-menu__link\">Пристрої для зберігання даних</a>
	  				</li>
	  			</ul>
	  		</li>
	  		<li>
	...
	if ($user_role>1) {
		$return .= "
			<div class=\"admin-options\">
				<a href=\"products.php?action=add_new_product\"><input type=\"button\" class=\"nav-button\" value=\"Додати новий продукт\"></a>
			</div>
		";
	}
...
function do_html_body_ventor_list($role){
	...
	if ($_SESSION['role']>1) {
		$return.="
			<div class=\"admin-options\">
				<a href=\"brands.php?action=add_brand\"><input type=\"button\" class=\"button1\" value=\"Додати новий бренд\"></a>
			</div>
		";
	}
	$return.="
...
function do_html_body_product_info($product_id,$role){
	...
	if ($role>1) {
		$return .= "
			<div class=\"admin-options\">
				<a href=\"products.php?action=add_quantity&product_id=".$_GET['product_id']."\"><input type=\"button\" class=\"nav-button\" value=\"Додати кількість\"></a>
				<a href=\"products.php?action=edit_product&product_id=".$_GET['product_id']."\"><input type=\"button\" class=\"nav-button\" value=\"Змінити продукт\"></a>
				<a href=\"products.php?action=delete_product&product_id=".$_GET['product_id']."\"><input type=\"button\" class=\"nav-button\" value=\"Видалити продукт\"></a>
			</div>
		";
	}
	$return .="
		...
		<div class=\"product-info\">
			...
			<div class=\"product-body__main-info\">
				...
				<form action=\"buy.php?action=adress_info&product_id=".$result['product_id']."\" method=\"post\">
					...
					<input type=\"submit\" value=\"Купити\" class=\"button1\">
				</form>
			</div>
		</div>
		<div class=\"product-body_description\">".$result['ua_description']."</div>	
	</div>";
	...
	$return .="
		<div class=\"comments\">
			<div class=\"comments__header\">Коментарі:</div>";
	...
	if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {		
		...
		$return .= "<div class=\"not-auth-comment\">Ввійдіть або зареєструйтесь для того щоб залишати коментарі.</div>";
	}
	$return.="</div>";
	echo $return;
}
...
function do_html_body_orders_list($role,$user_id){
	...
	foreach ($result as $key => $result) {
		...
		if (isset($result['tracking_number']) && !empty($result['tracking_number'])) {
			...
			$tracking_number = "Поки зо недоступно";
		}
	...
	echo"<footer class=\"footer\">
		<div class=\"container\">
			...
			<div class=\"lower-footer\">
				© 2022-2022 KaminskyVVDR. Все права захищені.
			</div>
	</footer></div>";
}
?>