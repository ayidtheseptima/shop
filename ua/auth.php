...
/*connecting to bd*/
  ...
  if (!empty($result['password'])) {
    ...
    echo "
      <script>
        alert('Неправильне імя пользователя!');
        window.location='auth.php';
      </script>
	...
	<div class=\"main_content\">
		<div class=\"authorization\">
			...
			<form method=\"post\" action=\"auth.php\">
				...
				<input class=\"authorization-input\" type=\"password\" name=\"password\" placeholder=\"пароль\"><br>
				<input class =\"auauthorization-button\" type=\"submit\" value=\"Ввійти\"><br>
				or<br>
				<a href=\"sign_up.php\"><input type=\"button\" class =\"auauthorization-button\" value=\"Зареєструватись\"></a>
			</form>
		</div>
	</div>";
}
